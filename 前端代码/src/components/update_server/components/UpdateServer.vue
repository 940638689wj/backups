    ...
    <el-tab-pane label="更新项目" name="update_server">
      <el-form ref="form" label-width="150px" id="form">
        ...
        <el-form-item>
          ...
          <div v-if="step == 2"><i class="el-icon-circle-check"></i><span style="margin-left:10px">解压覆盖完成，已关闭服务器</span></div>
          <div v-if="step == 2"><i class="el-icon-information"></i><span style="margin-left:10px">重启服务器中,请自行查看是否重启完成</span></div>
        </el-form-item>
      </el-form>
